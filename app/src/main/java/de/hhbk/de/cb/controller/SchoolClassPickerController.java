...
public class SchoolClassPickerController extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        activity.startActivity(new Intent(activity, SchoolSubject.class));
        //SchoolClass schoolClass = DummyDataLand.getInt().getSchoolClassByName(s); //Hier muss dann ein DB Anschluss hin!
    }
